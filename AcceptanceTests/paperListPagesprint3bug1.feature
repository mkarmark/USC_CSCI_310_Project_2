...
Scenario: Each element in conference column must be strictly greater or strictly less than following row
	Given a particular row
	Then the contents of the row is either row is either less than the row below and greater than the row above or greater than the row below and less than the row above
...
Scenario: The paper list accurately displays the right number of papers
	Given the user chooses ten as the number of papers
	Then the paper list page should show ten papers in the table
