...
if (!function_exists('curl_init')) {
  throw new Exception('ACM needs the CURL PHP extension.');
}
if (!function_exists('json_decode')) {
  throw new Exception('ACM needs the JSON PHP extension.');
}
...
class ACM {
	...
	public static $CURL_OPTS = array(
		...
		CURLOPT_TIMEOUT		=> 60,
		CURLOPT_USERAGENT	  => 'ACM-php-0.0.1',
	);
	...
	protected $_base_url = 'ACMxplore.ACM.org/gateway/ipsSearch.jsp';
	protected $_result   = '';
	protected $_use_ssl  = '';
	protected $_method   = '';
	...
	public function get_publication($arnumber) {
		$url = "http://ACMxplore.ACM.org/xpl/articleDetails.jsp?reload=true&tp=&arnumber=".$arnumber."&contentType=Journals+&+Magazines";
		...
		return "http://ACMxplore.ACM.org/xpl/tocresult.jsp?" . $out[0];
	}
